...
setup(
    ...
    license='MIT',
    packages=['ditic_kanban', 'new_ditic_kanban'],
    ...
    entry_points={
        'console_scripts': [
			...
			'ds = new_ditic_kanban.new_server:start_server',
			'gsf = new_ditic_kanban.rt_summary:generate_summary_file',
            'gsi = new_ditic_kanban.rt_summary:get_summary_info',
            'us = new_ditic_kanban.statistics:stats_update_json_file',
        ]
    }
)
